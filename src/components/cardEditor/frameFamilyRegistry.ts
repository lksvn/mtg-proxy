...
export const FRAME_FAMILIES: Record<FrameFamilyId, FrameFamily> = {
	...
	'eighth-edition': {
		...
		layout: {
			...
			mana: { right: 1372, centerY: 183, symbolSize: 64, gap: 4, font: '48px matrixb, serif', color: '#111' },
			type: { x: 153, y: 1240, maxWidth: 1195, font: '58px matrixb, serif', color: '#111' },
			...
			symbol: { centerX: 1345, centerY: 1236, boxSize: 82 },
			pt: { x: 1090, y: 1852, width: 309, height: 163, textX: 1253, textY: 1923, font: '70px matrixbsc, serif', color: '#111' },
			footer: {
				x: 112,
				maxWidth: 1216,
				metadataY: 1964,
