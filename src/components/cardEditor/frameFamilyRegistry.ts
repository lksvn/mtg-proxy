...
export const FRAME_FAMILIES: Record<FrameFamilyId, FrameFamily> = {
	...
	'fourth-era': {
		...
		layout: {
			...
			title: { x: 124, y: 108, maxWidth: 1252, font: '86px goudymedieval, serif', color: '#fff', shadowColor: '#111', shadowOffsetX: 3, shadowOffsetY: 3 },
			...
			symbol: { centerX: 1310, centerY: 1247, boxSize: 76 },
			...
			footer: {
				...
				disclaimerY: 2010, disclaimer: { font: '26px mplantin, serif', color: '#fff', shadowColor: '#111', shadowOffsetX: 2, shadowOffsetY: 2 },
			},
		},
