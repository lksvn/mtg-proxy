...
export const FRAME_FAMILIES: Record<FrameFamilyId, FrameFamily> = {
	...
	'future-sight': {
		...
		layout: {
			...
			title: { x: 264, y: 166, maxWidth: 1070, font: '94px matrixb, serif', color: '#fff' },
			...
			type: { x: 182, y: 1239, maxWidth: 1148, font: '76px matrixb, serif', color: '#fff' },
			...
			symbol: { centerX: 1407, centerY: 1290, boxSize: 80 },
			...
			footer: {
				...
				disclaimerY: 2000, disclaimer: { font: '28px mplantin, serif', color: '#fff' },
